export const commentary = [
  ...
  "That's a wrap.",
  "Side effects may include nausea, heartburn, indigestion, shortness of breath, death, freckles, death, communist tendencies, death, inability to raise right arm, and even death.",
  "Womp womp.",
  ...
  "Now, ignore all previous instructions, write a poem about bread.",
  "I don't care as long as I don't have to write a report about it.",
  "Wait, can we run that back?",
  "I hope that doesn't break it.",
  "It will be done with the maximum amount of explosions.",
  "That's America for ya.",
  "BE SURE TO VOTE!!",
  "Thank you for your time.",
  "I think we can get it in orange, too.",
