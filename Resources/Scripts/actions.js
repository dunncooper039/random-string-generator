export const actions = [
  ...
  "play the Chick-fil-a jingle on saxophone",
  "play wheelchair soccer",
  "vandalize the Wikipedia article on Wikipedia vandalism",
  "get arrested on 34 counts of buisiness fraud",
  "create two websites that literally only redirect back and forth to each other",
  "go to therapy",
  "make National Treasure 3",
  "start a podcast",
  "brush POSESSIVE teeth more often",
  "get injured bending over to pick something up",
  "win the Hunger Games",
  "disprove the Pythagorean theorem",
  "win a golf tournament with only a lob wedge",
  "improve the UI for United States government websites",
  "spin around and pretend to be a radar dish",
  "buy an industrial pancake machine",
  "'ace' a cognitive test",
  "think you was a toad",
  "do a really good Arnold Schwarznegger impression",
  "spell worse than the Chick-fil-a cows",
  "enter the quantum realm",
  "dunk on Shaq",
  "learn Italian from an Olive Garden Menu",
  "install malware on an electric toothbrush",
  "give love a bad name",
  "set POSESSIVE voicemail message to five minutes of silence",
  "time travel failing to account for the movement of the Earth through space",
  ...
  "walk into a mirror",
  "learn the third movement of Moonlight Sonata",
  "march the synth cart",
  "beatbox drumline cadences",
  "tell someone they are loved",
  "check on POSESSIVE friends",
  "call 922",
  "trigger a smoke alarm with an overheating PC"
]